...
#     page1 =YearPage("H:\\2011","http://tongji.cnki.net/kns55/Navi/YearBook.aspx?id=N2011090108&floor=1")
    page2 =YearPage(u"h:/《北京统计年鉴》/2014年","http://tongji.cnki.net/kns55/Navi/YearBook.aspx?id=N2014120106&floor=1")
#     page1.start()
    page2.start()